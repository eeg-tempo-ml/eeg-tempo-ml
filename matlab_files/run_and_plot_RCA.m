function dataOut = run_and_plot_RCA(song_num)
...
%% Load Song Data
% Add 20 to song_num, so song file will be found correctly
file_song_num = song_num + 20;
% Load the data from that song
X = loadOneFile(file_song_num); % Will be a 3D [time x space x trial] matrix
...
figure()
visualizeRCTopo125(A(:,1), 1) % 2nd function input is whether to plot the colorbar alongside
